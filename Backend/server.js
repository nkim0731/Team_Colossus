...
app.post('/login/google', async (req, res) => {
    ...
    try {
        let exist = await db.userExists(useremail);
        if (!exist) {
...
.get(async (req, res) => { // /api/calendar?user=username
    ...
    try {
        ...
        const events = await db.getCalendar(useremail);
...
.post(async (req, res) => {
    ...
    try {
        ...
        await db.addEvents(username, data.events);
...
.get(async (req, res) => { // ?user=username
    ...
    try {
        ...
        const schedule = await db.getSchedule(useremail);
